        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-700">
            <a
              ...
              href="https://www.linkedin.com/in/viswanathan2806?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BfmfRdMJUS4eesGRJpMzmiw%3D%3D"
            >
              Linkedin
              <FaLinkedin size={35} />
            </a>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/Vishwanathanselvamoorthy"
            >
              Github
              <FaGithub size={35} />
            </a>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="mailto:viswanathanselvamoorthy@gmail.com"
            >
              Email
